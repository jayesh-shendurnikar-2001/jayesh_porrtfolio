    ...
    >
      <div className="text-white py-5 flex justify-between items-center">
        ...
        <div className="text-lg font-semibold cursor-pointer">
          ...
          <span className="text-white">Shendurnikar</span>
          <span className="text-[#8245ec]">&gt;</span>
        </div>
        ...
        <div className="hidden md:flex space-x-4">
          <a
            href="https://github.com/jayesh-shendurnikar-2001"
            target="_blank"
          ...
          <a
            href="https://www.linkedin.com/in/jayesh-shendurnikar-830623226/?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
            target="_blank"
            rel="noopener noreferrer"
            className="text-gray-300 hover:text-[#8245ec]"
          >
