      ...
      <div className="flex flex-col-reverse md:flex-row justify-between items-center">
        ...
        <div className="md:w-1/2 text-center md:text-left mt-8 md:mt-0">
          ...
          <p className="text-base sm:text-lg md:text-lg text-gray-400 mb-10 mt-8 leading-relaxed">
            ...
            stack and Java (Spring Boot). Skilled in REST API development,
            system design, and performance optimization, with working knowledge
            of Generative AI integration. Proficient in delivering clean,
            maintainable, and production-ready solutions across modern web
            technologies.
          </p>
          {/* Resume Button */}
          <a
            href="https://drive.google.com/file/d/1ujHTeNJWkWu4NIzstuKqPjaxQlTEc_AP/view?usp=drive_link"
            target="_blank"
